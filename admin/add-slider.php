                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="card-title mt-4">Add Sliders</h4>
                            <div class="form-group">
                        <label for="description">Enter Slider Description:</label>
                    ...
                    <div class="text-end mt-4" style="text-align: left!important;">
                        ...
                        <a href="slider.php" style="margin-left: 5px;">Cancel</a>
