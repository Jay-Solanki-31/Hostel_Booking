  ...
  <footer id="footer" class="footer-style-2">
            ...
            <div class="footer_center bgr-footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-3">
                                <div class="widget">
                                    ...
                                    <div class="text">
                                        <p><i class="lotus-icon-location mr10"></i> Anand ,Gujarat </p>
                                        <p><i class="lotus-icon-phone mr10"></i> 2222555000</p>
                                        </p>
                                    </div>
                                </div>
                ...
                <div class="copyright">
                    <div class="container">
                        <p class="left inline-block f14">&copy; 2024 All rights reserved.</p>
