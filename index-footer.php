 ...
 <div class="footer_center bgr-footer">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-3">
                            <div class="widget">
                                ...
                                <div class="text">
                                    <p><i class="lotus-icon-location mr10"></i> 225 Beach Street, India </p>
                                    <p><i class="lotus-icon-phone mr10"></i>11-22-004455</p>
                                    </p>
                                </div>
                            </div>
            ...
            <div class="copyright">
                <div class="container">
                    <p class="left inline-block f14">&copy; 2023 All rights reserved.</p>
